...
import {
  ...
  recovered,
  confirm,
} from "../CHINAcomponent/tool.js";
import { getShortName } from "./tools";
export default class USAcharts extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  UNSAFE_componentWillReceiveProps(props) {
    ...
    var svgText = g
      ...
      .append("text")
      .text((d) => {
        if (d.properties.name !== "") return getShortName(d.properties.name);
      })
      .attr("x", function (d) {
        if (d.properties.name !== "") {
          let coor = projection([
